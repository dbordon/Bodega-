...
public class ciudad extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Formulario Ciudad", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 18))); // NOI18N
...
//           this.limpiar_txt();   
    ...
    private void btnsalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalirActionPerformed
      ...
      if(mensaje ==JOptionPane.YES_OPTION) {
          System.exit(WIDTH); //salir completamente del sistema 
    ...
    private void generar_codigo(){
        try {
            String sql = "select coalesce(max(id_ciudad),0)+1 as cod from ciudad";
    ...
    private void guardar() {
        ...
        try {
            ...
            if ("agregar".equals(operacion)){
                ...
                sql ="INSERT INTO ciudad VALUES("+codigo.getText()+",'"+descrip.getText().toUpperCase()+"')";
            ...
            if ("modificar".equals(operacion)){
                ...
                sql ="UPDATE ciudad set ciu_descripcion = '"+descrip.getText().toUpperCase()+"' where id_ciudad="+codigo.getText()+" ";
            ...
            if ("borrar".equals(operacion)){
                ...
                sql ="delete from ciudad where id_ciudad= "+codigo.getText()+" ";
                System.out.print(sql);// visualizar lo que se está ejecutanto
    ...
    private void cargar_grilla(){
        try {
            ...
            String sql = "select * from ciudad order by id_ciudad"; //consulta para cargar tabla
            ...
            while(rs.next()){ // va  a cargar con los valores del resultado (rs) obtenido en la consulta
                fila[0]= rs.getString("id_ciudad"); // datos de la fila 0= id's
                fila[1]= rs.getString("ciu_descripcion");//datos de la fila las descripciones
    ...
    private void buscar_ciudad(){
        try {
            String sql="select ciu_descripcion as descripcion from ciudad where id_ciudad="+codigo.getText();
            rs = con.Listar(sql);// Devolver en rs(variable), el resultado del primer registro
            rs.next();//devuelve todos los valores del resultado
    ...
    private void buscar() {
        try {
            ...
            String sql = "select * from ciudad where ciu_descripcion like '%"+buscar.getText().toUpperCase()+"%' order by id_ciudad";
            rs = con.Listar(sql);
            String[] fila1 = new String[2];//definimos la cantidad que poseera el array[]
            
            while (rs.next()) {
                fila1[0] = rs.getString("id_ciudad");
                fila1[1] = rs.getString("ciu_descripcion");
    ...
    private void validar_descripcion() {
        try {
            rs = con.Listar("SELECT * FROM ciudad WHERE ciu_descripcion = '"
