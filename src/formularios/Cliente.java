...
// COMENTARIO POR LINE   
    ...
    private void initComponents() {
        ...
        apellidos = new org.edisoncor.gui.textField.TextFieldRectBackground();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        panelNice1.setBackground(new java.awt.Color(64, 120, 201));

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registro de Clientes", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Black", 1, 18))); // NOI18N
        jPanel1.setOpaque(false);

        labelMetric1.setText("Código:");

        labelMetric2.setText("C.I o RUC:");
        ...
        direccion.setDescripcion("Ingrese Dirección");
        ...
        grilla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "C.I O Ruc", "Nombre", "Apellido", "Dirección", "Telefono"
            }
        ));
        ...
        telefono.setDescripcion("Ingrese Teléfono");
        ...
        ruc.setDescripcion("Ingrese, C.I O RUC");
        ...
        nombre.setDescripcion("Ingrese el Nombre");
        ...
        labelMetric6.setText("Apellido:");

        apellidos.setDescripcion("Ingrese Apellidos");
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(telefono, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
...
//        descrip.requestFocus();
    ...
    private void borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarActionPerformed
        if (codigo.getText().equals("")) {
            ...
            if (mensaje == JOptionPane.YES_OPTION) {
                ...
                con.BorrarDatos("clientes", "id_cliente", this.codigo.getText());
                limpiar_grilla();
                cargar_grilla();
    ...
    private void generar_codigo() {
        try {
            String sql = "SELECT COALESCE (max(id_cliente),0)+1 as cod from clientes;";
    ...
    private void guardar() {
        ...
        if (operacion == 2) {
            ...
            con.actualizar_datos("clientes", "ci_ruc='"+ruc.getText().toUpperCase()+"',"
                    +"cli_nombre='"+nombre.getText().toUpperCase()+"',"
                    +"cli_apellido='"+apellidos.getText().toUpperCase()+"',"
                    +"cli_direccion='"+direccion.getText().toUpperCase()+"',"
                    +"cli_telefono='"+telefono.getText()+"'",
                    " id_cliente=" + this.codigo.getText(), 1);
    ...
    private void cargar_grilla() {
        try {
            ...
            String sql = "select *from clientes order by id_cliente";//consulta p cargar tabla
            ...
            while (rs.next()) {//va a cargar con los valores del resultado (rs) optenido en la consulta
                fila[0] = rs.getString("id_cliente");//datos de la fila 0= id's
                fila[1] = rs.getString("ci_ruc"); //datos de la fila las descrip's
                fila[2] = rs.getString("cli_nombre");//datos de la fila 0= id's
                fila[3] = rs.getString("cli_apellido"); //datos de la fila las descrip's
                fila[4] = rs.getString("cli_direccion");//datos de la fila 0= id's
                fila[5] = rs.getString("cli_telefono"); //datos de la fila las descrip's
    ...
    private void verdatos() {
        ...
        ruc.setText(grilla.getValueAt(fila, 1).toString());
        nombre.setText(grilla.getValueAt(fila, 2).toString());
        apellidos.setText(grilla.getValueAt(fila, 2).toString());
        direccion.setText(grilla.getValueAt(fila, 4).toString());
        telefono.setText(grilla.getValueAt(fila, 5).toString());
    ...
    private void buscar() {
        try {
            ...
            String sql= "select *from clientes where ci_ruc like '%" + buscar.getText() + "%' order by id_cliente";
            rs = con.Listar(sql);
            String[] fila1 = new String[7];//definimos la cantidad que poseera el array[]

            while (rs.next()) {
                fila1[0] = rs.getString("id_cliente");//datos de la fila 0= id's
                fila1[1] = rs.getString("ci_ruc"); //datos de la fila las descrip's
                fila1[2] = rs.getString("cli_nombre");//datos de la fila 0= id's
                fila1[3] = rs.getString("cli_apellido"); //datos de la fila las descrip's
                fila1[4] = rs.getString("cli_direccion");//datos de la fila 0= id's
                fila1[5] = rs.getString("cli_telefono"); //datos de la fila las descrip's
        ...
        try {
            ...
            if (encontro == true) {
                JOptionPane.showMessageDialog(null, "El producto   "
                        + direccion.getText() + "   ya se encuentra registrada");
                // this.habilitar(1);
            } else {
                guardar();
            }
    ...
    private org.edisoncor.gui.textField.TextFieldRectBackground apellidos;
