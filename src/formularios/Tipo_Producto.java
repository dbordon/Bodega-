...
// COMENTARIO POR LINE   
    ...
    private void initComponents() {
        ...
        panelNice1.setBackground(new java.awt.Color(192, 201, 64));

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipo de Producto", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial Black", 1, 18))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelNice1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 630, Short.MAX_VALUE)
        );
    ...
    private void generar_codigo() {
        try {
            String sql = "SELECT COALESCE (max(cod_tipo_prod),0)+1 as cod from tipo_producto;";
    ...
    private void guardar() {
        try {
            ...
            if ("agregar".equals(operacion)) {
                ...
                sql = "insert into tipo_producto values(" + codigo.getText() + ",'" + descrip.getText().toUpperCase() + "')";
                System.out.println(sql);//visualizar lo que se está ejecutando
            }

            if ("Modificar".equals(operacion)) {
                sql = "update tipo_producto set t_p_descrip='" + descrip.getText().toUpperCase() + "'"
                        + " where cod_tipo_prod=" + codigo.getText() + "";
                System.out.println(sql);
                JOptionPane.showMessageDialog(this, "Modificado Correctamente");
            }
            if ("Borrar".equals(operacion)) {
                sql = "delete from tipo_producto where cod_tipo_prod=" + codigo.getText() + "";
                System.out.println(sql);
    ...
    private void cargar_grilla() {
        try {
            ...
            String sql = "select *from tipo_producto order by cod_tipo_prod";//consulta p cargar tabla
            ...
            while (rs.next()) {//va a cargar con los valores del resultado (rs) optenido en la consulta
                fila[0] = rs.getString("cod_tipo_prod");//datos de la fila 0= id's
                fila[1] = rs.getString("t_p_descrip"); //datos de la fila las descrip's
    ...
    private void buscar_ciudad() {
        try {
            String sql = "select t_p_descrip as desc from tipo_producto where cod_tipo_prod=" + codigo.getText() + "";
            rs = con.Listar(sql);
            rs.next();
            this.descrip.setText(rs.getString("desc"));
        } catch (SQLException ex) {
            Logger.getLogger(Tipo_Producto.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
