...
public class Venta extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cod_clie = new org.edisoncor.gui.textField.TextFieldRectBackground();
        cliente = new org.edisoncor.gui.textField.TextFieldRectBackground();
        labelMetric11 = new org.edisoncor.gui.label.LabelMetric();
        cbo_deposito = new javax.swing.JComboBox();
        ruc_ci = new org.edisoncor.gui.textField.TextFieldRectBackground();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(nro_fac, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        labelMetric6.setText("Cliente");
        labelMetric6.setColorDeSombra(new java.awt.Color(255, 255, 255));
        labelMetric6.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N

        cod_clie.setEnabled(false);
        cod_clie.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cod_clieActionPerformed(evt);
            }
        });
        cod_clie.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cod_clieKeyPressed(evt);
            }
        });
        ...
        ruc_ci.setEnabled(false);
        ruc_ci.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ruc_ciActionPerformed(evt);
            }
        });
        ruc_ci.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                ruc_ciKeyPressed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cod_clie, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(ruc_ci, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(34, 34, 34)
                .addComponent(cliente, javax.swing.GroupLayout.PREFERRED_SIZE, 276, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(50, 50, 50)
                ...
                .addComponent(cbo_deposito, javax.swing.GroupLayout.PREFERRED_SIZE, 233, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(cod_clie, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(labelMetric6, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(ruc_ci, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        txt_total.setDescripcion("Total Venta");
        ...
        labelMetric13.setText("Total Importe:");
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        ...
        deshab_botones(1);
        cod_clie.setEnabled(rootPaneCheckingEnabled);
        cod_clie.requestFocus(rootPaneCheckingEnabled);
    ...
    private void txt_cod_producKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_cod_producKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            VentanaBuscar busmar = new VentanaBuscar("select a.cod_producto, a.p_descrip, (a.precio*30)/100+a.precio as preciox\n"
    ...
    private void cod_clieKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cod_clieKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            //aqui definimos una matriz de tipo JTextField[] y el numero de columnas
            JTextField[] tfParam = new JTextField[3];
            //se le asigna donde va a mostrar el valor de cada columna
            tfParam[0] = this.cod_clie;
            tfParam[1] = this.ruc_ci;
            tfParam[2] = this.cliente;
            //instanciamos nuestra clase VentanaBuscar que se encuentra en el paquete clases
            //creamos la consulta con select de acuerdo a lo que queremos mostrar
            //en nuestra VentanaBuscar
            VentanaBuscar busmar = new VentanaBuscar("select id_cliente, ci_ruc, concat(cli_nombre,', ',cli_apellido) as Cliente, cli_direccion, cli_telefono\n"
                    + "from clientes where ci_ruc like",
                    new String[]{"CODIGO", "CI", "Cliente", "Dirección", "Telefono",}, 5, tfParam);
            //colocamos un titulo a nuestra VentanaBuscar con el comando setTitle
    ...
    }//GEN-LAST:event_cod_clieKeyPressed

    private void cod_clieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cod_clieActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cod_clieActionPerformed

    private void userKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_userKeyPressed

    }//GEN-LAST:event_userKeyPressed

    private void ruc_ciActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ruc_ciActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ruc_ciActionPerformed

    private void ruc_ciKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ruc_ciKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_ruc_ciKeyPressed
    ...
    private void generar_codigo() {
        try {
            String sql = "select coalesce(max(cod_venta),0)+1 as cod from venta";
    ...
    private void generar_codigo_factura() {
        try {
            String sql = "select coalesce(max(nro_factura),0)+1 as fac from venta";
            rs = con.Listar(sql);// Devolver en rs(variable), el resultado del primer registro
            rs.next();//devuelve todos los valores del resultado
            this.nro_fac.setText(rs.getString("fac"));
        } catch (SQLException ex) {
            Logger.getLogger(Venta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void grabar() {
        if (accion == 1) {
            ...
            con.insertar_datos("venta", "cod_venta,id_cliente,"
                    + "fecha,total_venta,estado,hora,nro_factura",
                    cod.getText() + ","
                    + cod_clie.getText() + ","
                    + "(select ('" + this.fecha.getText() + "')::date),"
                    + mon + "," + "'estado'" + ","
                    + "(select ('" + this.hora.getText() + "')::time),"
                    + nro_fac.getText() + "", 1);

            //grabar detalle
            for (int a = 0; a < grilla.getRowCount(); a++) {

                con.insertar_datos("det_venta", "cod_producto,cod_venta,cod_deposito,"
                        + "det_precio_unit,det_cantidad",
            ...
            for (int b = 0; b < grilla.getRowCount(); b++) {
                try {
                    ...
                    String sql = "update stock set cantidad=cantidad -" + grilla.getValueAt(b, 3)
                            + " where cod_producto=" + grilla.getValueAt(b, 0) + " and cod_deposito="
                            + "(select split_part('" + cbo_deposito.getSelectedItem() + "','-',1)::integer)";
            ...
            for (int c = 0; c < grilla.getRowCount(); c++) {
                try {

                    String sql = "update stock set cajas=cantidad/12 where cod_producto=" + grilla.getValueAt(c, 0) + " and cod_deposito="
                            + "(select split_part('" + cbo_deposito.getSelectedItem() + "','-',1)::integer)";
                    System.out.println(sql);
                    con.sentencia = con.conectar().createStatement();
                    con.sentencia.executeUpdate(sql);
    ...
    private org.edisoncor.gui.textField.TextFieldRectBackground cliente;
    private org.edisoncor.gui.textField.TextFieldRectBackground cod;
    private org.edisoncor.gui.textField.TextFieldRectBackground cod_clie;
    ...
    private org.edisoncor.gui.textField.TextFieldRectBackground ruc_ci;
